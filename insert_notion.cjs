...
const items = [
  {
    ...
    Insight:
      "Lewis 目前高流量的內容著重於「修正錯誤的顯化法」以及「極速見效（1天內）」。這顯示受眾對於傳統顯化法的疲勞，渴望更精確、立刻有感的路徑。",
  ...
  },
  {
    ...
    Insight:
      "市場上的新書趨勢已從「純粹的心靈法則」轉向「神經科學與頻率震動」的結合。這完美契合我們 TimeWaver 專案的「科學靈性」定位。",
  ...
  },
  {
    ...
    Insight:
      "結合特定赫茲（888Hz、432Hz）的「睡眠冥想」依然是絕對的流量密碼。在我們的「信息場音頻」戰略中，將 TimeWaver 特有的低頻調製（LF Modulation）隱藏於這些大眾熟悉的環境音軌中，能大幅降低受眾的接受門檻。",
